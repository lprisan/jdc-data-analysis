...
A first visual inspection (not rigorous video coding) of the moments of high (Load=4) and low load (Load=0), turns the following result:

**High load** episodes correspond to moments...
